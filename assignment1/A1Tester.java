...
public class A1Tester {
    ...
    public static void testArrayRange() {
        int[] result;
        
        // TODO: uncomment the following code to test this method
        
         result = ArrayOperations.arrayRange(a1);
         int[] shouldBe1 = {2, 2};
         //System.out.print("should be: ");
         //ArrayOperations.printArray(shouldBe1);
         //ArrayOperations.printArray(result);
         displayResults(ArrayOperations.arraysEqual(result,shouldBe1), "arrayRange");
         
         result = ArrayOperations.arrayRange(a4);
         int[] shouldBe4 = {0, 3};
         //System.out.print("should be: ");
         //ArrayOperations.printArray(shouldBe4);
         //ArrayOperations.printArray(result);
         displayResults(ArrayOperations.arraysEqual(result,shouldBe4), "arrayRange");
         
         result = ArrayOperations.arrayRange(a5);
         int[] shouldBe5 = {-1, 4};
         //System.out.print("should be: ");
         //ArrayOperations.printArray(shouldBe5);
         //ArrayOperations.printArray(result);
         displayResults(ArrayOperations.arraysEqual(result,shouldBe5), "arrayRange");
         
    }
    
    public static void testAreAllAbove() {
        boolean result, shouldBe;
        
        // TODO: uncomment the following code to test this method
        
        
         result = ArrayOperations.areAllAbove(a1, 2);
         shouldBe = false;
         //System.out.println("should be: " + shouldBe);
         //System.out.println("it is: " + result);
         displayResults(result==shouldBe, "areAllAbove");
         
         result = ArrayOperations.areAllAbove(a1, 1);
         shouldBe = true;
         //System.out.println("should be: " + shouldBe);
         //System.out.println("it is: " + result);
         displayResults(result==shouldBe, "areAllAbove");
         
         result = ArrayOperations.areAllAbove(a4, -1);
         shouldBe = true;
         //System.out.println("should be: " + shouldBe);
         //System.out.println("it is: " + result);
         displayResults(result==shouldBe, "areAllAbove");
         
         result = ArrayOperations.areAllAbove(a4, 0);
         shouldBe = false;
         //System.out.println("should be: " + shouldBe);
         //System.out.println("it is: " + result);
         displayResults(result==shouldBe, "areAllAbove");
    ...
    public static void testContains() {
        ...
        // TODO: uncomment the following code to test this method
         ...
         result = ArrayOperations.contains(a, aContained1);
         //System.out.println("should be true: " + result);
         displayResults(result, "testContains");
         
         result = ArrayOperations.contains(a, aContained2);
         //System.out.println("should be true: " + result);
         displayResults(result, "testContains");
         
         result = ArrayOperations.contains(a, aContained3);
         //System.out.println("should be true: " + result);
         displayResults(result, "testContains");
         
         result = ArrayOperations.contains(a, aNotContained1);
         //System.out.println("should be false: " + result);
         displayResults(!result, "testContains");
         
         result = ArrayOperations.contains(a, aNotContained2);
         //System.out.println("should be false: " + result);
         displayResults(!result, "testContains");
    ...
    public static void testCalcFood() {
        ...
        // TODO: uncomment the following code to test this method
         ...
         days = 28;
         result = ExpenseCalculator.calcFood(days);
         System.out.println("should be approx 1380: " + result);
         displayResults(Math.abs(result-1380)<THRESHOLD, "testCalcFood");
         
         days = 29;
         result = ExpenseCalculator.calcFood(days);
         System.out.println("should be approx 1286.36: " + result);
         displayResults(Math.abs(result-1286.36)<THRESHOLD, "testCalcFood");
    ...
    public static void testCalcHotel() {
        ...
        // TODO: uncomment the following code to test this method
         ...
         result = ExpenseCalculator.calcHotel(rate, nights);
    ...
    public static void testCalcAllExpenses() {
        ...
        // TODO: uncomment the following code to test this method
         ...
         result1 = ExpenseCalculator.calcAllExpenses(population1);
         //        System.out.print("should be:");
         ...
         result2 = ExpenseCalculator.calcAllExpenses(population3);
         //        System.out.print("should be:");
